...
var imported = siriuscore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new siriuscore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new siriuscore.URI(paymentInfo).toString();
```
